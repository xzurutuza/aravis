...
static void
arv_v4l2_stream_start_thread (ArvStream *stream)
{
...
static void
arv_v4l2_stream_stop_thread (ArvStream *stream)
{
	ArvV4l2Stream *v4l2_stream = ARV_V4L2_STREAM (stream);
	ArvV4l2StreamPrivate *priv = arv_v4l2_stream_get_instance_private (v4l2_stream);
	ArvV4l2StreamThreadData *thread_data;
...
ArvStream *
arv_v4l2_stream_new (ArvV4l2Device *device, ArvStreamCallback callback, void *callback_data, GError **error)
{
